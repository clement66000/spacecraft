...
import {StyleSheet, StatusBar, View, FlatList, Image, SafeAreaView} from "react-native";
...
export const StarshipFeedScreen = () => {
    ...
    if (isError) {
        return (
            <View style={[styles.container, {justifyContent: 'center', alignItems: 'center', backgroundColor: 'red'}]}>
    ...
    let renderItem = (props: RenderItemProps) => {
        ...
        const hyperdrive_rating = item.hyperdrive_rating;
        const price = item.cost_in_credits;
        const {manufacturer} = item;

        return (
            <Card mode={"outlined"}>
                <Image style={{width: "100%", height: 200, borderTopLeftRadius: 12,borderTopRightRadius: 12}} source={useImage(item.name)}/>
